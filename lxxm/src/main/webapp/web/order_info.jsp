...
<div id="container" class="clear">
    ...
    <div class="adress_choice">
		...
		<select style="margin: 20px;">
			...
			<option value="xx">${address.recvName} / ${address.recvPhone} / ${address.recvDistrict }, ${address.recvAddress }</option>
			</c:forEach>
		</select>
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <ul class="item_detail">
                <li class="p_info">
                    <b><img src="..${cart.goodsImage }" width="84" height="84" /></b>
                    <b class="product_name lf">${cart.goodsTitle }</b>
                    <br/>
                ...
                <li class="p_count">X<span>${cart.goodsNum }</span></li>
                <li class="p_tPrice">￥<span>${cart.goodsPrice * cart.goodsNum }</span></li>
            </ul>
            </c:forEach>
